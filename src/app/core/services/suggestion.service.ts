...
@Injectable({ //décorateur du service : indique que ce service peut être injecté dans d'autres composants ou services
  providedIn: 'root' //Qui ? Le service est disponible dans toute l'application - Combien ? Une seule instance (singleton)
})
